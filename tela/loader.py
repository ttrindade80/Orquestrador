...
# H-0043 / ADR-0036: unico valor reconhecido do campo raiz ``perfil``.
PERFIL_RESULTADO_EXECUCAO = "resultado_execucao"
_PERFIL_AUSENTE = object()

# Campos permitidos no consumidor D23 puro da tela de resultado (H-0043).
